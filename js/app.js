 ...
 */
    ...
    (() => {
        "use strict";
        var libs_utils_namespaceObject = {};
        __webpack_require__.r(libs_utils_namespaceObject);
        ...
        function initSliders() {
            if (document.querySelector(".blog-block__slider")) new core(".blog-block__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".doctors-block__slider")) new core(".doctors-block__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            if (document.querySelector(".portfolio-block__slider")) new core(".portfolio-block__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".awards-block__slider")) new core(".awards-block__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
...
***************************************************************************** */
        ...
        if (inputsPhone.length) inputsPhone.forEach((input => {
            intl_tel_input(input, {
                ...
                utilsScript: libs_utils_namespaceObject,
                initialCountry: "by"
            });

						...
						? ((b = 'number' == typeof b ? b : a),
						  this.each(function () {
								this.setSelectionRange
									...
									: this.createTextRange && ((c = this.createTextRange()), c.collapse(!0), c.moveEnd('character', b), c.moveStart('character', a), c.select());
						  }))
				...
				return (
					...
					this.trigger('unmask').each(function () {
						...
						function x(b) {
							if (!B.prop('readonly')) {
								...
								if (!(b.ctrlKey || b.altKey || b.metaKey || 32 > g) && g && 13 !== g) {
									if (
										(i.end - i.begin !== 0 && (y(i.begin, i.end), s(i.begin, i.end - 1)), (c = q(i.begin - 1)), n > c && ((d = String.fromCharCode(g)), j[c].test(d)))
									) {
						...
						function A(a) {
							...
							return (
								a ? z() : k > f + 1 ? (g.autoclear || C.join('') === D ? (B.val() && B.val(''), y(0, n)) : z()) : (z(), B.val(B.val().substring(0, f + 1))), k ? b : l
							);
						}
						var B = a(this),
